...
@Component({
    ...
    selector: "app-salary",
  imports: [CommonModule, FormsModule, InputTextModule, UiFormFieldComponent, TranslocoDirective, DropdownModule, UiDialogActionsComponent, CalendarModule, DateTypePipe, CheckboxModule]
})
export class SalaryComponent implements OnInit {
  ...
  SalaryTypeOptions = signal<{ id: SalaryTypeEnum; label: string }[]>([
    ...
    },
    {
      ...
      label: this._translocoService.translate('fixed'),
    },
  ]);
  ...
  onSaveClick(){
    ...
    stream$.pipe(tap((data) => console.log(data))).subscribe(() => this._ref.close(true));
  }
